...
class Research extends CI_Controller {
	...
	function insert_aktifitas($user, $keterangan){
     ...
     #fungsi cek hak akses
      function cek_hak_akses_user(){
          $kode_secure= 'x0023'; //  kode halaman user
     ...
     function index(){
          ...
          //pagination settings
        $config['base_url'] = base_url('administrator/research/');
        $config['total_rows'] = $this->db->count_all('research_view');
        $config['per_page'] = "10";
        ...
        $this->pagination->initialize($config);
          ...
          $data['post'] = $this->modelnews->data_limit("research_view",$where, 'id_post', $config["per_page"],$data['page'])->result();
          ...
          $this->load->view('admin/research/main',$data);
     ...
     function add(){
          ...
          $this->load->view('admin/include/header-profil', $data);
          $this->load->view('admin/include/navbar');
          $this->load->view('admin/research/add', $data);
          $this->load->view('admin/include/sidecontent');
          $this->load->view('admin/include/footer');
     }
     function edit(){
          ...
          $this->load->view('admin/include/header-profil', $data);
          $this->load->view('admin/include/navbar');
          $this->load->view('admin/research/edit',$data);
          $this->load->view('admin/include/sidecontent');
          $this->load->view('admin/include/footer');
     }
     function cekLogin(){
	 ...
	 $this->insert_aktifitas($kode, "Menambah Penelitian '".$judul."' ");
          redirect('administrator/research');
	 ...
	 $this->insert_aktifitas($kode, "Mengubah status penelitian ");
          redirect('administrator/pages');
     }
	...
	$user     = $this->cekLogin();
	 ...
	 $this->insert_aktifitas($user, "Menghapus research ID : '".$kode."' ");
        redirect('administrator/research');
    }
