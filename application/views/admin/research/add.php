            ...
            <section>
              <section class="vbox">
                ...
                <div class="loader">Saving data ...</div>
                  <div class="m-b-md">
                   <h3 class="m-b-none">Research</h3>
                  </div>
                  <form method="post" name="simpanberita" id="simpanberita" action="<?=base_url('administrator/research/save');?>">
                      <section class="hbox stretch">
                                  <!-- .aside -->
                            ...
                            <div class="wrapper">
                               ...
                               <div class="form-agenda">
                                    ...
                                    <div class="m-t-lg">
                                      ...
                                      <input type="button" onclick = "saveDraf('research')" id="savetoDraf" class="btn btn-sm btn-default" Value="Save to Draf"/>
                    ...
                    <aside>
                      <section class="panel panel-default">
                        <header class="panel-heading font-bold">Add New Research</header> 
...
function editLink(){
   ...
   $("#load_link").html("");
   $("#load_link").html("<b>Permalink : </b> " +homepage+"research/<input type='text' id='link_custom' value='"+link+"'/> <span class='btn btn-xs btn-bg btn-default' onclick=\"okLink()\">Ok</span> / <a onclick=\"batalLink()\"><small>Cancel</span></a>");
   $("#link_custom").focus();
}
function okLink(){
   ...
   $("#load_link").html("");
   $("#load_link").html("<b>Permalink : </b> " +homepage+"research/"+link_custom+" <span class='btn btn-xs btn-bg btn-default' onclick=\"editLink()\">edit</span>");
}
function batalLink(){
  //editCustomLine = false;
   ...
   link    = $("#link").val(judul);
   $("#load_link").html("");
   $("#load_link").html("<b>Permalink : </b> " +homepage+"research/"+judul+" <span class='btn btn-xs btn-bg btn-default' onclick=\"editLink()\">edit</span>");
    ...
    var auto = setInterval(
      function(){
       ...
       $(".loader").fadeIn();
       $.ajax({
        url:homepage+"administrator/research/autosave/?autosave=autosave&newslink="+newslink+"&konten="+kontent+"&kode="+kode+"&"+data,
             ...
             var hasil = result.split("|");
              ...
              if(kunci  =="ID"){
                ...
                if(editCustomLine == false){
                    $("#link").val(newslink);
                    $("#load_link").html("");
                    $("#load_link").html("<b>Permalink : </b> " +homepage+"research/"+ newslink+" <span class='btn btn-xs btn-bg btn-default' onclick=\"editLink()\">edit</span>");
                }else{
