              ...
              <section class="vbox">
                ...
                <section class="panel panel-default">
                  <header class="panel-heading">
                    Research data <span class='badge bg-info'>1</span>
                  </header>
              <form method="POST" id="cek-form" name="action" action="<?=base_url('administrator/research/action');?>"> 
                <div class="row wrapper">
                  <div class="col-sm-5 m-b-xs">
                    <select class="input-sm form-control input-s-sm inline v-middle" id='pilih' name='pilih'>
                     ...
                     <a href="<?=base_url('administrator/research/add');?>" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> Add Research</a>
                  </div>
                  ...
                  <table class="table table-striped b-t b-light">
                    ...
                    <tr>
                      ...
                      <div id='atribut-page-".$kode."'>
                        <small class='clear pull-left'><a href='".base_url('administrator/research/edit/'.$kode)."'><span class='text-primary'>edit</a></span> | <a href='".base_url('administrator/research/delete/'.$kode)."'><span class='text-danger'>delete</span></a>
                        | <a href='".base_url('administrator/announcement/eng_post/'.$kode.'/?k=research')."'><span class='text-warning'>english post</span></a></small>
