                                      ...
                                      <div class="col-sm-10">            
                                         <div class="btn-group m-r">
                                            ...
                                            <ul class="dropdown-menu dropdown-select">
                                              <li><a href='#'><input type='radio' name='bidang' id='bidang' value='Rekayasa Perangkat Lunak'>Rekayasa Perangkat Lunak</a></li>
                                              <li><a href='#'><input type='radio' name='bidang' id='bidang' value='Konstruksi Kayu'>Konstruksi Kayu</a></li>
                                              <li><a href='#'><input type='radio' name='bidang' id='bidang' value='Teknik Las'>Teknik Las</a></li>
                                              <li><a href='#'><input type='radio' name='bidang' id='bidang' value='Gambar Bangunan'>Gambar Bangunan</a></li>
                                              <li><a href='#'><input type='radio' name='bidang' id='bidang' value='Teknik Pemesinan'>Teknik Pemesinan</a></li>
                                              <li><a href='#'><input type='radio' name='bidang' id='bidang' value='Teknik Sepeda Motor'>Teknik Sepeda Motor</a></li>
                                              <li><a href='#'><input type='radio' name='bidang' id='bidang' value='Otomasi Industri'>Otomasi Industri</a></li>
                                              <li><a href='#'><input type='radio' name='bidang' id='bidang' value='Elektronika Industri'>Elektronika Industri</a></li>
                                            </ul>
                                         </div>
                                      </div>
                                    </div>
