            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder">
                  ...
                  <form id="formmenu" name="formmenu" action="<?=base_url('administrator/link/update/');?>" method="post" class="form-horizontal" >
						...
						<div class="panel-body">
							<div class="form-group">
					      	...
					      	<div class="form-group">
					        	...
					        	<div class="col-sm-10">
					            	<input class="form-control" value="<?=$link;?>" type="text" required name="link" id="link" >
					        	</div>
					      	</div>
						    	...
						    	<label class="col-sm-2 control-label">Root</label>
					         	<div class="col-sm-10">
						          <div class="btn-group m-r">
						              ...
						              <li ><a href="#"><input type="radio" value="0" name="root" id="root">(Make a root)</a></li>
						              	<?=$this->method_call->cek_perent($perent);?>
						              </ul> 
						            </div>
					            </div>
							</div>
							...
							<div class="line line-dashed b-b line-lg pull-in"></div>
							    <div class="form-group">
							      <label class="col-sm-2 control-label">Order</label>
							        <div class="col-sm-10">
							            <input class="form-control" value="<?=$no_urut;?>" required type="number" name ="nomer_urut" maxlength="2"   id="nomer_urut"  >
							        </div>
