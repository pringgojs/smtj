              ...
              <section class="vbox">
                <section class="scrollable padder">
                 <div class="loader">Checking data ...</div>
                  ...
                  <form action="<?=base_url('administrator/module/save');?>" name="simpanberita" id="simpanberita" method="post" class="form-horizontal" >
                    <section class="panel panel-default">
                      <div class="panel-body">
                      	<div class="form-group">
                            <label class="col-sm-2 control-label">Label</label>
                            <div class="col-sm-10">
                                <input required class="form-control" type="text" name="label" id="label" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label class="col-sm-2 control-label" style="margin-top:10px">Link</label>
                            <div class="col-sm-10">
                                ...
                                <div class="col-sm-10"> <input readonly="" style="margin-top:10px" class="form-control" type="text" name ="link" id="link"  >
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            ...
                            <div class="col-sm-10"> <input class="form-control" readonly="" style="margin-top:10px" name ="icon" id="icon"  >
                            </div>
                          </div>
                        </div>
                        <div class="line line-dashed b-b line-lg pull-in"></div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label">Order</label>
                            <div class="col-sm-10">
                                <input class="form-control" required type="text" name ="nomer_urut" size="16"  id="nomer_urut"  >
                            </div>
                        </div>
                        <div class="line line-dashed b-b line-lg pull-in"></div>
                        <div class="form-group">
