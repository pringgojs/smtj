            ...
            <section>
              <section class="vbox">
                ...
                <div class="loader">Saving data ...</div>
                  ...
                  <form method="post" name="simpanberita" id="simpanberita" action="<?=base_url('administrator/agenda/save');?>">
                      <section class="hbox stretch">
                                  <!-- .aside -->
                            ...
                            <div class="wrapper">
                               ...
                               <div class="form-agenda">
                                    ...
                                    <div class="m-t-lg">
                                      ...
                                      <input type="button" onclick = "saveDraf('agenda')" id="savetoDraf" class="btn btn-sm btn-default" Value="Save to Draf"/>
                    ...
                    <aside>
                      <section class="panel panel-default">
                        <header class="panel-heading font-bold">Add New Agenda</header> 
...
function okLink(){
   ...
   $("#load_link").html("");
   $("#load_link").html("<b>Permalink : </b> " +homepage+"agenda/"+link_custom+" <span class='btn btn-xs btn-bg btn-default' onclick=\"editLink()\">edit</span>");
}
function batalLink(){
  //editCustomLine = false;
   ...
   link    = $("#link").val(judul);
   $("#load_link").html("");
   $("#load_link").html("<b>Permalink : </b> " +homepage+"agenda/"+judul+" <span class='btn btn-xs btn-bg btn-default' onclick=\"editLink()\">edit</span>");
    ...
    var auto = setInterval(
      function(){
       ...
       $(".loader").fadeIn();
       $.ajax({
        url:homepage+"administrator/agenda/autosave/?autosave=autosave&newslink="+newslink+"&konten="+kontent+"&kode="+kode+"&"+data,
             ...
             var hasil = result.split("|");
              ...
              if(kunci  =="ID"){
                ...
                if(editCustomLine == false){
                    $("#link").val(newslink);
                    $("#load_link").html("");
                    $("#load_link").html("<b>Permalink : </b> " +homepage+"agenda/"+ newslink+" <span class='btn btn-xs btn-bg btn-default' onclick=\"editLink()\">edit</span>");
                }else{
