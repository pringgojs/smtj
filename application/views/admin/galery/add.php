            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder">
                  <div class="m-b-md">
                   <h3 class="m-b-none">Create New Albume</h3>
                    <small>In this page you can add the new albume foto.</small>
                   
                  </div>
                  <!-- start row -->
                  <form id="formmenu" name="formmenu" action="<?=base_url('administrator/galery/save/');?>" method="post" class="form-horizontal" >
                  <div class="row">
                    <div class="col-lg-12">
                      <section class="panel panel-default" id="box-1">
                        <div class="panel-body">
                          <div class="col-lg-5">
                            ...
                            <div id="thum">
                              <img id="img" onclick="notif('galery')" style="max-width:100%; height:auto; width:auto" src="<?=base_url('asset/images/not-img.png');?>">
                            </div>                          
                          </div>
                          <div class="col-lg-7">
                          <div class="h3 m-t-xs m-b-xs" id="judul-1">Attribute Albume</div>
                            <div class="form-group">
                              <label class="col-sm-2 control-label">Title</label>
                               <div class="col-sm-10">
                                  <input class="form-control" required type="text" name ="label" id="label"  >
                                  <input class="form-control" required type="hidden" name ="kode_file" id="kode_file"  >
                          ...
                          <section class="panel panel-default">
                           <header class="panel-heading text-right bg-light">
                            ...
                            <div class="panel-heading b-b">
                              ...
                              <button class="btn btn-primary" onclick="selectUrlAlbume()">Select Image</button>
