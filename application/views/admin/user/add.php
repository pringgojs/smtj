              ...
              <section class="vbox">
                <section class="scrollable padder">
                 <div class="loader">Checking data ...</div>
                  ...
                  <form action="<?=base_url('administrator/user/save');?>" name="simpanberita" id="simpanberita" method="post" class="form-horizontal" >
                      ...
                      <div class="panel-body">
                           ...
                           <div class="col-sm-10">              
                            <div class="btn-group m-r">
                              ...
                              <ul class="dropdown-menu dropdown-select">
                                <li ><a href='#'><input type='radio'  name='jabatan' id='jabatan' value='Administrator'>Administrator</a></li>
                                <li class="active"><a href='#'><input type='radio' name='jabatan' checked="checked" id='jabatan' value='Operator'>Operator</a></li>
                        ...
                        <div class="form-group">
                          <label class="col-sm-2 control-label" style="margin-top:10px">Username</label>
                            <div class="col-sm-10">
                              <input  style="margin-top:10px" class="form-control" type="text" name ="username" id="username"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                           <div class="col-sm-4 col-sm-offset-2">
                            <input type="submit" name="simpanberita" id="simpanberita" class="btn btn-sm btn-primary" Value="Save User"/>
                           </div>
                        </div>
                      </div>
                    </section>
