              ...
              <section class="vbox">
                <section class="scrollable padder">
                 <div class="loader">Checking data ...</div>
                  ...
                  <form action="<?=base_url('administrator/user/update');?>" name="simpanberita" id="simpanberita" method="post" class="form-horizontal" >
                    <section class="panel panel-default">
                      <div class="panel-body">
                           ...
                           <div class="col-sm-10">              
                            <div class="btn-group m-r">
                              <button data-toggle="dropdown" class="btn btn-sm btn-default dropdown-toggle">
                                <span class="dropdown-label">Choose Jabatan</span> 
                                <span class="caret"></span>
                              </button>
                              <ul class="dropdown-menu dropdown-select">
                                <?php 
                                if($jabatan == "Administrator"){
                                  echo "<li class='active'><a href='#'><input type='radio' checked='' name='jabatan' id='jabatan' value='Administrator'>Administrator</a></li>
                                <li><a href='#'><input type='radio' name='jabatan' id='jabatan' value='Operator'>Operator</a></li>
                                ";
                                }else{
                                  echo "<li ><a href='#'><input type='radio'  name='jabatan' id='jabatan' value='Administrator'>Administrator</a></li>
                                <li  class='active'><a href='#'><input type='radio' checked='' name='jabatan' id='jabatan' value='Operator'>Operator</a></li>
                                ";
                                }?>
                        ...
                        <div class="line line-dashed b-b line-lg pull-in"></div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" style="margin-top:10px">Access Point</label>
                          <div class="col-sm-10">
                            <div class="panel-body">
                              <b href="#" class="text-info"> Give access for user in this system security.</b>
                              <div class="checkbox i-checks"><label class="i-checks">
                                <input type="checkbox" id="cek" onClick="cek_modul()" value="All"><i></i>Check All</label>
                              </div>
                              <div class="clear">

                                <?=$this->method_call->cek_module($kode);?>
