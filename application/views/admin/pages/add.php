            ...
            <section>
              <section class="vbox">
                ...
                <div class="loader">Saving data ...</div>
                  ...
                  <form method="post" name="simpanberita" id="simpanberita" action="<?=base_url('administrator/pages/save');?>">
                      <section class="hbox stretch">
                                  <!-- .aside -->
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="btn-group m-r">
                                      <button data-toggle="dropdown" class="btn btn-sm btn-default dropdown-toggle">
                                         <span class="dropdown-label">Choose Parent </span> 
                                         <span class="caret"></span>
                                      </button>
                                      <ul class="dropdown-menu dropdown-select">
                                          <?php
                                            $this->method_call->pages_parent_view('add','0');
                                          ?>
                                        </ul> 
                                    </div>
                                    </div>  
                                    ...
                                    <div class="m-t-lg">
                                      ...
                                      <input type="button" onclick = "saveDraf('pages')" id="savetoDraf" class="btn btn-sm btn-default" Value="Save to Draf"/>
                    ...
                    <aside>
                      <section class="panel panel-default">
                        <header class="panel-heading font-bold">Add New Page</header> 
...
function okLink(){
   ...
   $("#load_link").html("");
   $("#load_link").html("<b>Permalink : </b> " +homepage+link_custom+" <span class='btn btn-xs btn-bg btn-default' onclick=\"editLink()\">edit</span>");
}
function batalLink(){
  //editCustomLine = false;
   ...
   link    = $("#link").val(judul);
   $("#load_link").html("");
   $("#load_link").html("<b>Permalink : </b> " +homepage+judul+" <span class='btn btn-xs btn-bg btn-default' onclick=\"editLink()\">edit</span>");
             ...
             var hasil = result.split("|");
              ...
              if(kunci  =="ID"){
                ...
                if(editCustomLine == false){
                    $("#link").val(newslink);
                    $("#load_link").html("");
                    $("#load_link").html("<b>Permalink : </b> " +homepage+ newslink+" <span class='btn btn-xs btn-bg btn-default' onclick=\"editLink()\">edit</span>");
                }else{
