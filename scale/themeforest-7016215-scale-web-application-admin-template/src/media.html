        ...
        <section id="content">
          <section class="vbox">
            <header class="header bg-light lt b-b b-light">
              <p class="h4 font-thin pull-left m-r m-b-sm">Medias</p>
                    ...
                    <div class="panel-body">
                      <ul class="list-unstyled m-t-n-sm">
                        <li class="checkbox i-checks">
                          <label>
                            <input type="checkbox" checked><i></i> Nature
                          </label>
                        </li>
                        <li class="checkbox i-checks">
                          <label>
                            <input type="checkbox" checked><i></i> Food and Drink
                          </label>
                        </li>
                        <li class="checkbox i-checks">
                          <label>
                            <input type="checkbox"><i></i> Model Released
                          </label>
                        </li>
                        <li class="checkbox i-checks">
                          <label>
                            <input type="checkbox"><i></i> Animals/Wildlife
                          </label>
                        </li>
                        <li class="checkbox i-checks">
                          <label>
                            <input type="checkbox"><i></i> Abstract
                          </label>
                        </li>
                        <li class="checkbox i-checks">
                          <label>
                            <input type="checkbox"><i></i> Beauty/Fashion
                          </label>
                        </li>
                        <li class="checkbox i-checks">
                          <label>
                            <input type="checkbox"><i></i> Business
                          </label>
                        </li>
                      </ul>
                      ...
                      <ul class="list-unstyled">
                        <li class="radio i-checks">
                          <label>
                            <input type="radio" name="filter" checked><i></i> Today
                          </label>
                        </li>
                        <li class="radio i-checks">
                          <label>
                  ...
                  <div class="row row-sm">
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        ...
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Skyline collection</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        ...
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Morbi nec nunc condimentum</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        ...
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Vestibulum ullamcorper sodales nisi</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        ...
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Lorem ipsum dolor sit amet</p>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix visible-xs"></div>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        <a href="#"><img src="images/p0.jpg" alt=""></a>
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Donec eleifend condimentum nisl eu consectetur.</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        ...
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Duis non malesuada est</p>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix visible-xs"></div>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        <a href="#"><img src="images/p0.jpg" alt=""></a>
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Mauris convallis mauris at pellentesque</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        ...
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Donec eleifend</p>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix visible-xs"></div>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        ...
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Vestibulum ullamcorper sodales</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        <a href="#"><img src="images/p0.jpg" alt=""></a>
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Dapibus porta</p>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix visible-xs"></div>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                      <div class="thumbnail">
                        <a href="#"><img src="images/p9.jpg" alt=""></a>
                        <div class="caption">
                          <p class="text-ellipsis m-b-none">Phasellus at ultricies neque,</p>
                        </div>
                      </div>
                    </div>
                  </div>
